...
# --------------------------------------------------
# Service Start Functions (Mac Compatible)
# --------------------------------------------------
start_kafka() {
    if ! check_kafka; then
        echo "Starting Kafka..."
...
start_k3s() {
    ...
    # Mac-compatible sed (requires empty string for backup extension)
...
# --------------------------------------------------
# Mac-Compatible Docker Management
# --------------------------------------------------
check_docker() {
    ...
    if ! docker info &>/dev/null; then
        echo "Docker is not running. Please start Docker Desktop and wait for it to become ready."
        open -a Docker
...
# --------------------------------------------------
main() {
    # Check Docker availability (Mac compatible)
    check_docker
